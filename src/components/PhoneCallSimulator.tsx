...
const simulateLocalResponse = (inputText: string, gender: "female" | "male") => {
  ...
  if (isTransferRequested) {
    replyText = gender === "female"
      ? `รับทราบและเข้าใจแล้วค่ะ เดี๋ยวเหลือน้องกัญญาขอกดโอนสายไปยังเจ้าหน้าที่ฝ่ายดูแลตรงช่องทางนี้ด่วนเลยนะคะ กรุณารอสักครู่เดียวค่ะ`
      : `รับทราบและเข้าใจแล้วครับ เดี๋ยวพี่ภูขอกดโอนสายไปยังเจ้าหน้าที่ฝ่ายดูแลตรงช่องทางนี้ด่วนเลยครับ กรุณารอสักครู่เดียวครับ`;
    transferTriggered = true;
    transferDepartment = "sales";
  } else if (isIssue) {
    replyText = gender === "female"
      ? `อุ๊ย ต้องขอประทานโทษด้วยนะคะที่พบปัญหาขัดข้องของเครื่องชงกาแฟ ไม่ต้องกังวลนะคะ เดี๋ยวน้องกัญญาจะรีบกดโอนสายไปยังแผนกช่างเทคนิคดูแลช่วยเหลือด่วน ณ บัดนี้เลยค่ะ กรุณารอสักครู่ค่ะ`
      : `อุ๊ย ต้องขอประทานโทษด้วยครับที่พบปัญหาขัดข้องของเครื่องชงกาแฟ ไม่ต้องกังวลนะครับ เดี๋ยวพี่ภูจะรีบกดโอนสายไปยังแผนกช่างเทคนิคดูแลช่วยเหลือด่วน ณ บัดนี้เลยครับ กรุณารอสักครู่ครับ`;
    transferTriggered = true;
    transferDepartment = "technician";
  } else if (isCoffeeQuery) {
    replyText = gender === "female"
      ? `สำหรับราคาเมล็ดกาแฟค้าส่งของ December Day Coffee เรามีโปรโมชั่นและราคาเรตส่งพิเศษสำหรับร้านบาริสต้าคาเฟ่เลยค่ะ สนใจเมล็ดคั่วอ่อน คั่วกลาง หรือเข้มดีคะ? หรือจะโอนสายคุยกับฝ่ายขายดีคะ`
      : `สำหรับราคาเมล็ดกาแฟค้าส่งของ December Day Coffee เรามีโปรโมชั่นและราคาเรตส่งพิเศษสำหรับร้านบาริสต้าคาเฟ่ครับ สนใจเมล็ดคั่วอ่อน คั่วกลาง หรือเข้มดีครับ? หรือจะโอนสายคุยกับฝ่ายขายดีครับ`;
  } else if (/สวัสดี|ดีครับ|ดีค่ะ|ฮัลโหล/.test(lastMessage)) {
    replyText = gender === "female"
      ? `สวัสดีค่ะ! น้องกัญญาจาก December Day Coffee ยินดีต้อนรับค่ะ วันนี้สนใจสอบถามข้อมูลเมล็ดกาแฟ หรือต้องการแจ้งซ่อมเครื่องชงขัดข้องคะ?`
      : `สวัสดีครับ! พี่ภูจาก December Day Coffee ยินดีต้อนรับครับ วันนี้สนใจสอบถามข้อมูลเมล็ดกาแฟ หรือต้องการแจ้งซ่อมเครื่องชงขัดข้องครับ`;
  } else {
    replyText = gender === "female"
      ? `รับทราบข้อมูลและยินดีประสานงานให้เลยค่ะ ตอนนี้หน้างานขัดข้องเรื่องใดเพิ่มเติมอีกไหมคะ หรือต้องการให้น้องกัญญาโอนสายหาแผนกผู้เชี่ยวชาญเลยดีคะ?`
      : `รับทราบข้อมูลและยินดีประสานงานให้เลยครับ ตอนนี้หน้างานขัดข้องเรื่องใดเพิ่มเติมอีกไหมครับ หรือต้องการให้พี่ภูโอนสายหาแผนกผู้เชี่ยวชาญเลยดีครับ?`;
  }
